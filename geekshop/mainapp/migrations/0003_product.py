...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0002_auto_20210701_1548'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128, verbose_name='имя родукта')),
                ('image', models.ImageField(blank=True, upload_to='product_images')),
                ('short_desk', models.CharField(blank=True, max_length=128, verbose_name='краткое описание')),
